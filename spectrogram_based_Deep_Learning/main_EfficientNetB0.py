# -*- coding: utf-8 -*-
"""
Created on Tue Apr 27 18:09:37 2021
...
model = EfficientNetB0(include_top=True, weights= None, input_shape = trainX[0].shape, classes=nb_classes)
