...
data['Type'] = data['Type'].replace('Tone', 1)
data['Type'] = data['Type'].replace('SP', 1) 
data['Type'] = data['Type'].replace('PA', 1)  
...
print('\n******* Model development with 8 features ******************')
...
print('\n******* Model development with 7 features ******************')
